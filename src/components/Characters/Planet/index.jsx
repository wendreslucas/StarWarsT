    ...
    <div/>
        ...
        {page <= 6 ? (
          <>
            ...
            <PaginationButton isActive={page === 4} onClick={() => setPage(4)}>
              4
            </PaginationButton>
            <PaginationButton isActive={page === 5} onClick={() => setPage(5)}>
              5
            </PaginationButton>
            <PaginationButton isActive={page === 6} onClick={() => setPage(6)}>
              6
            </PaginationButton>
          </>
        ) : (
